            ...
            <div className="min-h-screen bg-brand-black font-sans text-zinc-300 selection:bg-[#a3e635] selection:text-black flex flex-col md:flex-row">
                    ...
                    groups={[
                        {
                            title: "Components",
                            items: [
                                { id: "form-controls", label: "01_Form_Controls" },
                                { id: "navigation", label: "02_Navigation" },
                                { id: "display", label: "03_Display" },
                                { id: "feedback", label: "04_Feedback" },
                                { id: "interactive", label: "05_Interactive" },
                                { id: "structure", label: "06_Structure" },
                            ]
                        }
                    ]}
                />
                ...
                <main className="flex-1 p-8 md:p-16 overflow-y-auto h-screen scroll-smooth bg-zinc-950/50">
                    <div className="max-w-7xl mx-auto space-y-16 pb-40">
                        ...
                        <section id="form-controls" className="space-y-8 scroll-mt-20">
                        ...
                        <section id="display" className="space-y-8 scroll-mt-20">
                        ...
                        <section id="feedback" className="space-y-8 scroll-mt-20">
                        ...
                        <section id="interactive" className="space-y-8 scroll-mt-20">
                        ...
                        <section id="structure" className="space-y-8 scroll-mt-20">
