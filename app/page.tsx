            ...
            <main className="flex-1 p-8 md:p-16 overflow-y-auto h-screen scroll-smooth bg-zinc-950 bg-grid-zinc">
                <div className="max-w-7xl mx-auto space-y-40 pb-40 relative z-10">
                    ...
                    <section id="widgets" className="scroll-mt-20">
                        <SectionHeader title="Mission Control" subtitle="v7_Industrial_Holo_Hybrid" icon={LayoutGrid} />
...
function SectionHeader({ title, subtitle, icon: Icon, link }: { title: string, subtitle?: string, icon?: any, link?: { href: string, label: string } }) {
    return (
